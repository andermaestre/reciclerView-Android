...
public class RecyclerVersionArrayAdapter extends RecyclerView.Adapter<RecyclerVersionArrayAdapter.ViewHolder>{
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setImgLogo(int num){imgLogo.setBackground(parent.getDrawable(num));}
    }
